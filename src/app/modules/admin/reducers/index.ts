...
import { roomsReducer, RoomsState, getRoomList, getRoomListTotal, getRoomsLoading, getRoomsError, getRoomsSearch } from './rooms';
...
export const getRoomsSearchState = createSelector(getRoomsState, getRoomsSearch);
